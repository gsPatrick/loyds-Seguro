...
const Hero = () => {
    ...
    const insuranceLinks = [
        { name: 'Seguro Auto', href: '/seguros/carro', icon: <FaCar className="mr-2"/> },
        { name: 'Seguro Moto', href: '/seguros/moto', icon: <FaMotorcycle className="mr-2"/> },
        { name: 'Plano Mensal 24h', href: '/seguros/mensal', icon: <FaCalendarCheck className="mr-2"/> }, // Ajustado o nome para bater com a estrutura
    ];
