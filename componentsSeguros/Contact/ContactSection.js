...
import { FaPhone, FaEnvelope, FaWhatsapp, FaLinkedin } from 'react-icons/fa'; // Ícones

const ContactSection = () => {
  const buttonRef = useRef(null); // Ref para o botão de email
  ...
  const socialLinks = [
    { icon: <FaWhatsapp size={24} />, href: 'https://wa.me/5511999998888', name: 'WhatsApp' },
    { icon: <FaLinkedin size={24} />, href: 'https://linkedin.com/in/seulinkedin', name: 'LinkedIn' },
  ];
  ...
  return (
    <section 
      ...
      style={{ backgroundColor: '#121313' }} // Fundo escuro
    >
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="flex flex-col justify-center text-white text-center lg:text-left">
            ...
            <motion.div variants={itemVariants} className="space-y-4 mb-8">
              <div className="flex items-center justify-center lg:justify-start gap-3">
                ...
                <a href="tel:+5511999998888" className="text-white/80 hover:text-white transition-colors duration-300">+55 11 99999-8888</a>
              </div>
              <div className="flex items-center justify-center lg:justify-start gap-3">
                <FaEnvelope className="text-white/80" />
                <a href="mailto:contato@loydsseguros.com" className="text-white/80 hover:text-white transition-colors duration-300">contato@loydsseguros.com</a>
              </div>
            </motion.div>
          ...
          {/* Lado Direito: Botão para E-mail */}
          <motion.div
            variants={itemVariants} // O botão herda a animação de entrada
            ref={buttonRef}
            ...
            style={{ 
              ...
              boxShadow: '0 0 0px transparent' // Sombra inicial nula
            }}
            onMouseMove={(e) => {
            ...
            whileHover={{ boxShadow: '0 0 30px rgba(255, 255, 255, 0.15)' }} // Sombra no hover
          >
            <Link href="mailto:contato@loydsseguros.com?subject=Contato%20via%20Site%20Loyds%20Seguros&body=Ol%C3%A1%2C%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20os%20seguros." passHref legacyBehavior>
              <motion.a 
